// ============================================================
// rtls.ks  (RTLS bullseye with final-burn settle fix)
//
...
UNTIL FALSE {
    ...
    ELSE IF phase = PH_TOUCHDOWN {
        ...
        // close to the pad and close to the ground, freeze lateral chase; the
        // previous touchdown loop turned a 9 m bullseye into a 300 m skid by
        // continuing to lean after the landing burn had already solved miss.
        LOCAL corrN IS 0.
        LOCAL corrE IS 0.
